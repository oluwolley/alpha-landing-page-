...
const Footer = () => {
  return (
    <footer className="bg-[#2A0A4A] py-12 px-4 md:px-6 w-full overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-xl font-bold mb-4">Alpha</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors">Shared Inbox</a></li>
